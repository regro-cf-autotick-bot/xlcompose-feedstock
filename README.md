...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/xlcompose-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11208&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/xlcompose-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `xlcompose` can be installed with:

```
conda install xlcompose
```

It is possible to list all of the versions of `xlcompose` available on your platform with:
